...
for year in range(2001,2021):
    ...
    for f in folders:
        ...
        fire_prop_excl_single_annual = fire_data.get_burn_area_excluding_single_pixel_fire()
...
fire_data.plot_hist_for_given_proportion(dict_proportions = fire_prop_excl_single, proportion_name = 'Burned Proportion Excluding Single Pixel Fires', plot_output_path = post_processed_path)
