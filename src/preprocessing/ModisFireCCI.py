    ...
    * `User Guide
    ...
    def get_single_pixel_fire_proportion(self):
        ...
        for dataArray in self.data:
            ...
            dict_proportions[str(dataArray.date.values)] = one_pixel__fire_count / total_count
    ...
    def get_burn_area_excluding_single_pixel_fire(self):
        ...
        burn_proportion_excl_single =  {key: burn_area[key] - single_fires.get(key, 0) for key in burn_area  } 
    ...
    def plot_hist_for_given_proportion(self, dict_proportions, proportion_name, plot_output_path):
