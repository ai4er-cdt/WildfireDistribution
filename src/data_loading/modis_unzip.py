...
def unzip_all_modis_fire_files(output_path):
    ...
    file_part3 = ['/neodc/esacci/fire/data/burned_area/MODIS/pixel/v5.1/compressed/2019/2019{0}01-ESACCI-L3S_FIRE-BA-MODIS-AREA_3-fv5.1.tar.gz'.format(month) for month in months[:9]]
    file_part4 = ['/neodc/esacci/fire/data/burned_area/MODIS/pixel/v5.1/compressed/2019/new-corrected/2019{0}01-ESACCI-L3S_FIRE-BA-MODIS-AREA_3-fv5.1.tar.gz'.format(month) for month in months[-3:]]
    ...
    for file_name in files:
        ...
        try:
            dat = dateutil.parser.parse(str(file_name[68:80].replace('/',' ')), fuzzy='yes')
